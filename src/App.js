...
function App() {
  ...
  return (
    <>
      ...
      <Canvas pixelRatio={window.devicePixelRatio} camera={{ position: [0, 2, 3] }} shadowMap colorManagement>
        <ambientLight color={'#232323'}/>
        <pointLight position={[0, 10, 2]} intensity={1} distance={0} decay={2} castShadow={false}/>
